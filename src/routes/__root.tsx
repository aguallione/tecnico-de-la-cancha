...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Juego de Director Técnico de Fútbol" },
      { name: "description", content: "Simulador de DT: armá tu plantel, elegí táctica y viví el partido narrado por un relator." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Juego de Director Técnico de Fútbol" },
