 ...
 * MY_SUPABASE_SERVICE_ROLE_KEY, que bypassa RLS y es la autoridad única del motor
...
export function getServiceClient(): SupabaseClient {
  ...
  if (!serviceKey) throw new Error("Falta MY_SUPABASE_SERVICE_ROLE_KEY en el servidor.");
